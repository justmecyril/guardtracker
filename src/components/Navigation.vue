    ...
    <nav class="flex items-center gap-4 px-4 py-5">
      ...
      <div class="flex justify-end flex-1 gap-x-10">
        <div class="relative group">
          ...
          <nav
            tabindex="0"
            class="absolute left-0 invisible w-12 text-white transition-all border border-2 border-gray-800 rounded bg-light-green top-full group-focus-within:visible group-focus-within:opacity-100 group-focus-within:translate-y-1"
          >
            <ul class="py-1">
              <li>
                <router-link
